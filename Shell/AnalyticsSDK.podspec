...
TODO: Add long description of the pod here.
  ...
  s.source_files = ['AnalyticsSDK/**/*.{c,h,m}']

  #s.ios.vendored_frameworks = ['lib/AppsFlyerLib.framework','lib/HeyzapAds.framework','lib/XZZStrategySDK.framework']
  ...
  #s.pod_target_xcconfig = { 'GCC_PREPROCESSOR_DEFINITIONS' => 'ZZADSDK_DEBUG=1'}
